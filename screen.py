...
class Screen:
    ...
    def __init__(self):
        ...
        self.cursor.to_pos(self.get_width()-1, self.get_height()-1)
    ...
    def input_movement(self):
        """ Looks for WASD/Arrow key movement. """

        return self.cursor.input()
    ...
    def clear_screen(self):
        ...
        self.cursor.to_pos(self.get_width(), self.get_height())
        self.write(colorama.ansi.clear_screen())
        self.cursor.reset_pos()
        self.cursor.save_position(
            "Debug", [self.get_width()-1, self.get_height()-1])
    ...
    def input(self, screen, limit=1000):
        """ Get keyboard input with a limit of how many characters the user
        cant type """
